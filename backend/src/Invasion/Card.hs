...
allCards =
  Map.fromList
    ...
    [ ("core-001", UnitCardDef defenderOfTheHold),
      ...
      ("the-fourth-waystone-088", UnitCardDef lionChariotOfChrace),
      ...
      ("the-fourth-waystone-098", TacticCardDef aNobleQuest),
      ...
      ("signs-in-the-stars-063", SupportCardDef gyrocopter),
      ("signs-in-the-stars-075", UnitCardDef beastlordRakarth),
      ("signs-in-the-stars-066", QuestCardDef dreamsUvConkwest),
      ("signs-in-the-stars-067", UnitCardDef luthorHuss),
      ...
      ("the-twin-tailed-comet-045", UnitCardDef orcShaman),
      ...
      ("omens-of-ruin-014", SupportCardDef denOfIniquity),
      ...
      ("fiery-dawn-102", TacticCardDef grudgebornFury),
      ("fiery-dawn-110", UnitCardDef hawkeyeArcher),
      ("fiery-dawn-111", SupportCardDef barracksOfChrace),
      ("fiery-dawn-113", UnitCardDef keeperOfSecrets),
      ...
      ("fiery-dawn-120", TacticCardDef theWildHunt),
